...
**Troubleshooting:** If macOS blocks the app, go to **System Settings** → **Privacy & Security** and click **"Open Anyway"**. If you see "Life Map is damaged", run `xattr -cr /Applications/Life\ Map.app` in Terminal.
